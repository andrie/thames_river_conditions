...
walton   = hcc.get_metric("Walton",   parameter = "flow", since = seven).loc[:, ["dateTime", "value"]]
kingston = hcc.get_metric("Kingston", parameter = "flow", since = seven).loc[:, ["dateTime", "value"]]
