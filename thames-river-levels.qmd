...
A flow rate of about **100 umecs** at Walton seems to be the range when **yellow caution** (stream increasing) appear, and higher than **150 cumecs** when the **red caution** (strong stream) appear.

Note that a negative flow rate at Kingston means that the incoming tide is high and river flow is actually upstream.
:::
