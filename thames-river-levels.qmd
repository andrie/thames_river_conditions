...
## Water level at Sunbury Lock

```{python}
hcc.plot_thames_level("Sunbury")
```

::: {.column-margin}
What does the Sunbury lock water level mean at the club house?

5.05m : water lapping over step to club house, canoe drying area under water (all time peak reached on 20014-11-02)
